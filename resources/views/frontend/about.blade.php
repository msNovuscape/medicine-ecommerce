@extends('frontend.master')
    ...
    <div class="ps-wishlist">
        ...
        <br/><br/>
            ...
            Steps we follow on each order :<br/>
            We receive 3 types of order:<br/>
            1. Over the counter medicines<br/>
            We do not require any prescription so our Pharmacist confirms the order, pack it, call customer before the delivery and is delivered on preferred date, time and location. <br/>
            2. Prescription Medicines<br/>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="thumbnail thumbnail--no-border">
                                            ...
                                            <br/>
                                                ...
                                                <div class = "aboutText">Buying prescription drugs online is easy, safe and secure at Online Aushadhi. We offer convenient ordering online
                                                    ...
                                                    which we take very seriously. To ensure this to our customers, <strong>we procure all our supplies directly from only
                                                        the authorized distributors of the country</strong>.</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="thumbnail thumbnail--no-border">
                                            ...
                                            <br/>
                                                ...
                                                <div class = "aboutText">Our Customer Support Team is accessible Sunday to Friday from 9am to 6pm through email and by phone. If you
