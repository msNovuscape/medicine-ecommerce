        ...
        <div class="row">
                        <div class="col-lg-12">
                            <div class="content__gutter-up-down content__gutter-left-right">
                                    <div class="col-lg-12">
                                            <h5 class="text-uppercase">{{$page->first()->title}}</h5>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="thumbnail thumbnail--no-border">
                                            ...
                                            <div class="caption">
                                                ...
                                                Buying prescription drugs online is easy, safe and secure at Online Aushadhi. We offer convenient ordering online
                                                    ...
                                                    which we take very seriously. To ensure this to our customers, <strong>we procure all our supplies directly from only
                                                        the authorized distributors of the country</strong>.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="thumbnail thumbnail--no-border">
                                            ...
                                            <div class="caption">
                                                ...
                                                Our Customer Support Team is accessible Sunday to Friday from 9am to 6pm through email and by phone. If you
