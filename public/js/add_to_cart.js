            ...
            success:function(response){
                ...
                $.each(response.results,function(index,value){
                    ...
                    $("#search_response").append(
                        '<div class="col-12 col-lg-6"><div class="ps-product ps-product--horizontal"><div class="ps-product__thumbnail"><a class="ps-product__image" href="/product?id='+value.id+'"><figure><img src="'+value.img+'" alt="Image unavailable" /></figure></a></div><div class="ps-product__content" style = "margin-top:0px"><h4 class="ps-product__title ps-product__price sale"><a style = "margin-top:10px" href = "/product?id='+value.id+'">'+value.medicine_name+'</a></h4><p style = "margin-top:-20px">'+value.composition+'</p><p style = "margin-top:-10px">'+value.company_name+'</p><p style = "margin-top:-7px">'+value.brand_name+'</p><div class="ps-product__meta" style = "margin-top:-7px"><span class="ps-product__price sale">Rs '+value.sp_per_piece+'</span></div></div></div></div>'
                );
                });
